...
<body id="reportsPage">
            ...
            <div class="container h-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto h-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="adminView/html/viewProducts.jsp">
                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${orders}" var="current">
                                <tbody>
                                    <tr>
                                        <th scope="row"><b># ${current.id}</b></th>
                                        <td>
                                            <div class="tm-status-circle moving">
                                            </div>${current.status}
                                        </td>
                                        <!-- <td><b>${current.user.name}</b></td> -->
                                        <td><b></b></td>
                                        <td><b>${current.address}</b></td>
                                        <td><b>${current.orderDate}</b></td>
                                    </tr>
    ...
    <script src="adminView/js/moment.min.js"></script>
    <!-- https://momentjs.com/ -->
    <script src="adminView/js/Chart.min.js"></script>
    <!-- http://www.chartjs.org/docs/latest/ -->
    <script src="adminView/js/bootstrap.min.js"></script>
    <!-- https://getbootstrap.com/ -->
    <script src="adminView/js/tooplate-scripts.js"></script>
    <script>
