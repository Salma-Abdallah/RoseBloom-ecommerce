                    ...
                    <div class="home-slideshow">
                        <div class="slide">
                            <div class="blur-up lazyload bg-size">
                                <img class="blur-up lazyload bg-img" data-src="view/images/3.jpg"
                                    src="view/images/3.jpg" alt="Shop Our New Collection"
                                ...
                                <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                                    <div class="slideshow__text-content bottom">
                                        <div class="wrap-caption center">
                                            ...
                                            <a href="ProductServlet?categoryName=Plants"><span class="btn">Shop
                                                    now</span></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="slide">
                            <div class="blur-up lazyload bg-size">
                                <img class="blur-up lazyload bg-img" data-src="view/images/4.jpg"
                                    src="view/images/4.jpg" alt="Summer Plants Collection"
                                    title="Summer plants Collection" />
                                <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                                    <div class="slideshow__text-content bottom">
                                        <div class="wrap-caption center">
                        ...
                        <div class="slide">
                            <div class="blur-up lazyload bg-size">
                                <img class="blur-up lazyload bg-img" data-src="view/images/1.jpg"
                                    src="view/images/1.jpg" alt="Shop Our New Collection"
                                    title="Shop Our New Collection" />
                                <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                                    <div class="slideshow__text-content bottom">
                                        <div class="wrap-caption center">
                        ...
                        <div class="slide">
                            <div class="blur-up lazyload bg-size">
                                <img class="blur-up lazyload bg-img" data-src="view/images/2.jpg"
                                    src="view/images/2.jpg" alt="Summer Bikini Collection"
                        ...
                        <div class="collection-grid">
                            <div class="collection-grid-item">
                                <a href="ProductServlet?categoryName=Plants" class="collection-grid-item__link">
                                    <img data-src="view/images/g3.jpg" src="view/images/g3.jpg" alt="plants"
                                        class="blur-up lazyload" height="290" />
                            ...
                            <div class="collection-grid-item">
                                <a href="ProductServlet?categoryName=Garden Supplies"
                                    class="collection-grid-item__link">
                                    <img class="blur-up lazyload" data-src="view/images/gardenSupplies.jpg"
                                        src="view/images/gardenSupplies.jpg" alt="Garden Supplies" height="290" />
                                    <div class="collection-grid-item__title-wrapper">
                                        <h3 class="collection-grid-item__title btn btn--secondary no-border">Garden
                                            Supplies</h3>
                                    </div>
                                </a>
                            </div>
                            <div class="collection-grid-item blur-up lazyloaded">
                                <a href="ProductServlet?categoryName=Pots" class="collection-grid-item__link">
                                    <img data-src="view/images/pots.jpg" src="view/images/pots.jpg" alt="pots"
                                        class="blur-up lazyload" height="290" />
                                    <div class="collection-grid-item__title-wrapper">
                            ...
                            <div class="collection-grid-item">
                                <a href="ProductServlet?categoryName=Gifts" class="collection-grid-item__link">
                                    <img data-src="view/images/gift.jpg" src="view/images/gift.jpg" alt="gifts"
                                        class="blur-up lazyload" height="290" />
                                    <div class="collection-grid-item__title-wrapper">
                            ...
                            <div class="collection-grid-item">
                                <a href="collection-page.html" class="collection-grid-item__link">
                                    <img data-src="view/images/gardenGuide.webp" src="view/images/gardenGuide.webp"
                                        alt="Garden Guide" class="blur-up lazyload" height="290" />
                                    <div class="collection-grid-item__title-wrapper">
                                        <h3 class="collection-grid-item__title btn btn--secondary no-border">Garden
                                            Guide</h3>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 about-right offset-lg-1">
                                ...
                                <p class="mt-4 mb-5">RoseBloom is a plant shop web application
                                    that brings the best plants and trees for you and outstands by providing plant
                                    Carefor all our plants to have a nice
                    ...
                    <div class="row py-sm-5">
                        <div class="col-lg-6 col-sm-8 col-10">
                            <div class="feedback-top">
                                <p><i class="fa fa-quote-left" aria-hidden="true"></i>The very best relationship has a
                                    gardener and a flower.
                ...
                <div class="newsletter-wrap" id="popup-container">
                    <div id="popup-window">
                        ...
                        <div class="display-table splash-bg">
                            <div class="display-table-cell width40"><img src="view/images/bg.jpg"
